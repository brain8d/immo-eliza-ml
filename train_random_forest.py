...
def train():
    ...
    # Train the model
    model = RandomForestRegressor(n_estimators=100, random_state=42)  # Initialize Random Forest Regressor
    ...
    joblib.dump(artifacts, "models/artifacts-random-forest.joblib")
